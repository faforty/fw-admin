...
<template>
    <div class="upload">
        ...
        <input type="file" class="upload" @change="fileChange" v-bind:accept="accepts" v-bind:multiple="multiple">
        ...
        <div class="crop" v-if="showCrop" transition="crop"  :style="{height:cropHeight+'px'}">
            ...
            <div class="dialog" :style="{width:width+'px',top:cropTop+'px'}" v-if="showCropDialog">
                ...
                <footer>
                    <button class="upload-btn"@click="cropCancel">{{cancel}}</button>
                    <button class="upload-btn" @click="cropOK">{{ok}}</button>
                </footer>
